...
class AllinstructorController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('checkbox', function ($row) {
                        ...
                        <input type='checkbox' form='bulk_delete_form' class='filled-in material-checkbox-input instructors' name='checked[]'' value='$row->id' id='checkbox$row->id'>                              <label for='checkbox$row->id' class='material-checkbox'></label>
                            </div>";
    ...
    public function edit($id)
    {
        ...
        return view('admin.allinstructor.edit',compact('cities','states','countries','user','cities','states','countries'));
