...
class AlluserController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('checkbox', function ($row) {
                        ...
                        <input type='checkbox' form='bulk_delete_form' class='filled-in material-checkbox-input student' name='checked[]' value='$row->id' id='checkbox$row->id'>                            </div>";
    ...
    public function edit($id)
    {
        ...
        return view('admin.alluser.edit',compact('cities','states','countries','user','cities','states','countries'));
