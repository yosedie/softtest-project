...
$('#dynamic_field').on('click', '.add', function () {
    ...
    $('#dynamic_field').append('<tr id="row' + i + '" class="dynamic-added"> <td>' +
        '<input type="text" name="course[]" class="form-control"></td>' +
        '<td><input type="text" class="form-control" name="school[]"></td>' +
        '<td><input class="form-control" type="text"name="marks[]" ></td>' +
        '<td><input class="form-control" type="text" name="yearofpassing"></td>' +
        '<td><button type="button" name="remove" id="' + i + '" class="btn btn-outline-danger btn-rounded btn-sm btn_remove ml-1">X</button></td></tr>');
});
...
$(document).on('ready', function () {
    ...
    $('#dynamic_field1').on('click', '.add1', function () {
        ...
        $('#dynamic_field1').append('<tr id="row' + i + '" class="dynamic-added1">' +
            ...
            '<td><input type="text" class="" class="form-control" name="enddate[]" ></td>' +
            ...
            '<td><input type="text" class="form-control" name="employer[]" ></td>' +

            '<td><button type="button" name="remove" id="' + i + '" class="btn btn-outline-danger btn-rounded btn-sm btn_remove1">X</button></td></tr>');
    });
...
$(document).on('ready', function () {
    ...
    $('#dynamic_field2').on('click', '.add2', function () {
        ...
        $('#dynamic_field2').append('<tr id="row' + i + '" class="dynamic-added2">' +
            ' <td><input type="text" class="form-control" name="projecttitle[]"></td>' +
