      ...
      <div class="preL display-none">
        <div class="preloader3 display-none"></div>
          ...
          <div class="card-header">
            ...
            <form autocomplete="off" action="{{ route('importfileupdate') }}" id="step2form" method="POST" class="database-validation" novalidate>
              @csrf
              ...
              <div class="col-md-6 mb-3">
                   <label for="DB_HOST">{{__('Database Host: ex. 127.0.0.1/localhost')}}</label>
        ...
        <p class="text-center m-3 text-white">&copy;{{ date('Y') }} {{__('| eClass - Learning Management System | Installer v1.1 | ')}}<a class="text-white" href="http://mediacity.co.in" title="{{__('Media City')}}" target="_blank">{{__('Media City')}}</a></p>
   		</div>
