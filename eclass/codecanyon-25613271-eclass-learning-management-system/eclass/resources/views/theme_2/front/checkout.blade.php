		...
		<div class="cart-items btm-30">
	            		...
	            		<div id="accordion" class="second-accordion">
						    ...
						    <div class="card">
							    ...
							    <div id="collapseOne" class="panel-collapse collapse in">
							        <div class="card-body">
										@php
										// Check if session 'meeting_price' exists and decrypt it if found, otherwise decrypt $secureamount
										$finalAmount = session()->has('meeting_price') ? Crypt::decrypt(session('meeting_price')) : Crypt::decrypt($secureamount);
										@endphp
		                            			...
		                            			@csrf
											        ...
											        <div class="col-md-12">
														...
														<input type="hidden" name="amount" value="{{ session()->has('meeting_price') ? session('meeting_price') : $secureamount }}" />
											                ...
											                {{-- <input type="hidden" name="amount" class="form-control" placeholder="" value="{{ $secureamount }}" readonly=""> --}}
											            </div>
											        </div>
											        <div class="col-md-12 mt-4">
											            <button class="btn btn-primary" title="checkout" type="submit">{{ __('Proceed') }}</button>
           ...
           value="{{ session()->has('meeting_price') ? session('meeting_price') : Crypt::decrypt($secureamount) }}" />
							...
							<div class="card">
								...
								<hr>
								@endif
								@endif{{ Crypt::decrypt($secureamount) }}{{ __('Proceed') }}</button>
														</form>
												...
												<div class="row">
											        <div class="col-md-12">
											            <div class="form-group">
											                ...
											                <input type="text" name="email" class="form-control"   placeholder="email@email.com" required autocomplete="off">
											        ...
											        <div class="col-md-12">
											            <div class="form-group">
											                ...
											                <input type="text" name="mobile" class="form-control"  placeholder="+905350000000" required autocomplete="off">
											            </div>
											        </div>
