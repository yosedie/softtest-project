            ...
            <div class="col-lg-3 col-sm-6">
                <div class="categories-block">
                    <div class="categories-block-one">
                        <ul>
                            <li><a href="{{ route('subcategory.page', ['categorySlug' => $cat->categories->slug, 'slug' => $cat->slug]) }}" title="{{ $cat->title }}"><i class="fa {{ $cat->icon }}"></i>
                                </a></li>
                            <li><a href="{{ route('subcategory.page', ['categorySlug' => $cat->categories->slug, 'slug' => $cat->slug]) }}" title="{{ $cat->title }}">{{ $cat->title }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="categories-block">
                    <ul>
                        ...
                        <li><a href="{{ route('childcategory.page',['categorySlug' => $cat->categories->slug, 'subCategorySlug' => $cat->subcategory->slug ,'slug' => $cat->slug ]) }}">{{ $cat->title }}</a></li>
                    </ul>
                </div>
            </div>
            @endif
                                            ...
                                            <div class="panel-heading active" role="tab" id="headingOnexxx">
                                                <h4 class="panel-title">
                                                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnexxx{{ $cate->id }}" aria-expanded="false" aria-controls="collapseOnexxx">
                                                        <label class="prime-cat" data-url="{{ route('category.page',['slug' => $cate->slug]) }}">{{ str_limit($cate->title, $limit = 20, $end = '..') }}</label>
                                                    </a>
                                                </h4>
                                            </div>
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" role="tab" id="headingelevenxxx">
                                                            <h4 class="panel-title">
                                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseelevenxxx{{ $sub->id }}" aria-expanded="false" aria-controls="collapseelevenxxx">
                                                                    <label class="sub-cate" data-url="{{ route('subcategory.page', ['categorySlug' => $sub->categories->slug, 'slug' => $sub->slug]) }}">{{ str_limit($sub->title, $limit = 15, $end = '..') }}</label>
                                                        ...
                                                        <div id="collapseelevenxxx{{ $sub->id }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingelevenxxx">
                                                            ...
                                                            <div class="panel-body sub-cat">
                                                                <label class="child-cate" data-url="{{ route('childcategory.page',['categorySlug' => $child->categories->slug, 'subCategorySlug' => $child->subcategory->slug ,'slug' =>  $child->slug ]) }}">{{ $child->title }} </label>
                                                            </div>
                                                            @endif
                                                            @endforeach
                                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6 categories-popularity-dtl-block">
                                        <div class="categories-popularity-dtl courses-content">
                                            ...
                                            <h3><a href="{{ route('user.course.show',['slug' => $course->slug ]) }}">{{ str_limit($course->title, $limit = 18, $end = '..') }}</a></h3>
                                            <ul>
