...
<section id="comimg-soon" class="coming-soon-main-block" style="background-image: url('{{ asset('images/comingsoon/'.$data->bg_image) }}')">
    ...
    <div class="container-xl">
        ...
        <div class="coming-soon-block">
            ...
            <div class="facts-dtl-block btm-40 countdown">
                <div class="row">
                    <div class="offset-lg-2 col-lg-2 col-md-3 col-sm-6 col-6">
                        <div class="facts-block text-center btm-20">
                            <h1 class="facts-heading js-days">{{ $data->count_one }}</h1>
                            <div class="facts-dtl">{{ $data->text_one }}</div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <div class="facts-block text-center btm-20">
                            <h1 class="facts-heading js-hours">{{ $data->count_two }}</h1>
                            <div class="facts-dtl">{{ $data->text_two }}</div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <div class="facts-block text-center btm-20">
                            <h1 class="facts-heading js-minutes">{{ $data->count_three }}</h1>
                            <div class="facts-dtl">{{ $data->text_three }}</div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <div class="facts-block text-center btm-20">
                            <h1 class="facts-heading js-seconds">{{ $data->count_four }}</h1>
                            <div class="facts-dtl">{{ $data->text_four }}</div>
                        </div>
                    </div>
                </div>
            </div>
