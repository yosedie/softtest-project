                                      ...
                                      <div class="view-block">
                                          ...
                                          <div class="view-user-img">
                                            ...
                                            <a href="" title="{{$c->title}}"><img src="{{ asset('images/user_img/'.$c->user['user_img']) }}"
                                                    class="img-fluid user-img-one user-img-three" alt="{{$c->title}}"></a>
                                            @else
                                          ...
                                          <div class="view-dtl">
                                              ...
                                              <div class="user-name">
                                                <h6>{{__('By')}} <span><a href="">{{ optional($c->user)['fname'] }}</a></span></h6>
                                            </div>                                           
                                             <div class="rating">
                                                  <ul>
                                                      <li>
                                                          ...
                                                          <div class="pull-left">
                                                              <div class="star-ratings-sprite"><span style="width:<?php echo $ratings_var; ?>{{ __('%\" class=\"star-ratings-sprite-rating\">') }}</span>
                                                              </div>
                                                          </div>
                                                            ...
                                                            <div class="rate text-right">
                                                                <ul>
                                                                    ...
                                                                    @if($c->discount_price == !NULL)
                                                                        ...
                                                                        <li><a><b><i class="{{ $currency->icon }}"></i>{{ $c->discount_price }}</b></a></li>{{ __('&nbsp;') }}<li><a><b><strike><i class="{{ $currency->icon }}"></i>{{ $c->price }}</strike></b></a></li>
