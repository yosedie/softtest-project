            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="bredcrumb-dtl">
                        <h1 class="wishlist-home-heading">{{ __('Instructor')}}</h1>
                    </div>
                </div>
            </div>
        </div>
								...
								<div class="col-lg-8 col-md-7 col-12">
									<div class="instructor-content-block">
										...
										<div class="about-reward-badges">
											...
											<img src="{{url('images/badges/4.png')}}" class="img-fluid" alt="{{ $data }} users has enrolled" data-toggle="tooltip" data-placement="bottom" title=" {{ $data }} users has enrolled">
										</div>
									</div>
								</div>
			...
			<div class="col-lg-6">
				<div class="instructor-tabs">
					<ul class="nav nav-tabs" id="tabs-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="about-tab" data-toggle="tab" href="#about" role="tab" aria-controls="about" aria-selected="true">{{ __('About me') }}</a>
						</li>
						<li class="nav-item">
								...
								<div class="row">
									<div class="col-lg-4 col-6">
										<div class="tab-badges-block text-center">
											<img src="{{url('images/badges/1.png')}}" class="img-fluid" alt="{{ $year }}">
											<div class="tab-badges-heading">{{__('Trusted User')}}</div>
											<p>{{__('Member since')}} {{ $year }}</p>
										</div>
									</div>
									@if($course_count >= 5)
									<div class="col-lg-4 col-6">
										<div class="tab-badges-block text-center">
											<img src="{{url('images/badges/2.png')}}" class="img-fluid" alt="{{__('Courses')}}">
											<div class="tab-badges-heading">{{__('Senior Instructor')}}</div>
											<p>{{__('Has')}} {{ $course_count }} {{__('Courses')}}</p>
										</div>
									</div>
									@endif
									<div class="col-lg-4 col-6">
										<div class="tab-badges-block text-center">
											<img src="{{url('images/badges/3.png')}}" class="img-fluid" alt="{{__('Courses Rating from 4 to 5')}}">
											<div class="tab-badges-heading">{{__('Golden Courses')}}</div>
											<p>{{__('Courses Rating from 4 to 5')}}</p>
										</div>
									</div>
									<div class="col-lg-4 col-6">
										<div class="tab-badges-block text-center">
											<img src="{{url('images/badges/4.png')}}" class="img-fluid" alt="{{ $data }} ">
