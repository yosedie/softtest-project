		...
		<div class="col-lg-12">
			<div class="card m-b-30">
				<div class="card-header">
					<h5 class="card-title">{{ __('Create Jitsi Meeting') }}</h5>
					<div>
						<div class="widgetbar">
							<a href="{{url('jitsi-dashboard')}}" class="btn btn-primary-rgba"
								title="{{ __('Close') }}"><i class="feather icon-arrow-left mr-2"></i>{{
								__("Back")}}</a>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form autocomplete="off" action="{{ route('jitsi.meeting.save') }}" method="POST"
						...
						<div class="row">
							<div class="form-group col-md-4">
								...
								<div class="input-group mb-3">
									<div class="input-group-prepend">
										<span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload')
											}}</span>
									</div>
									<div class="custom-file">
										<input accept="image/*" type="file" name="image" class="custom-file-input"
											id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
										<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file')
											}}</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group col-md-3" id="sec4_four">
								...
								<div class="input-group">
									<input name="start_time" type="text" id="time-format" class="form-control"
							...
							<div class="form-group col-md-3" id="sec5_four">
								...
								<div class="input-group">
									<input name="end_time" type="text" id="time-format1" class="form-control"
										placeholder="dd/mm/yyyy - hh:ii aa" aria-describedby="basic-addon5" />
									<div class="input-group-append">
										<span class="input-group-text" id="basic-addon5"><i
												class="feather icon-calendar"></i></span>
							...
							<div class="form-group col-md-3">
								...
								<small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('Set to None if
									you want to use your account timezone') }}.</small>
							</div>
							<div class="form-group col-md-3">
								<label for="paidMeetingToggle">{{ __('Paid Meeting') }}:</label>
								<input type="checkbox" id="paidMeetingToggle" name="paid_meeting_toggle"
									class="custom_toggle" value="1">
							</div>

							<div class="form-group col-md-3" id="paidMeetingPrice">
						...
						<div class="form-group col-md-6">
							<button type="reset" class="btn btn-danger-rgba" title="{{ __('Reset') }}"><i
									class="fa fa-ban"></i> {{ __('Reset') }}</button>
							<button type="submit" class="btn btn-primary-rgba" title="{{ __('Create') }}"><i
