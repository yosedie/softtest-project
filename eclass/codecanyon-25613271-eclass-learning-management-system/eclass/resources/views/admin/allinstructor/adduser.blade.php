...
@section('maincontent')
<?php
$data['heading'] = 'Create A New Instructor';
$data['title'] = 'Create A New Instructor';
?>
    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        <div class="card-header">
          <h5 class="box-tittle">{{ __('Create A New Instructor') }}</h5>
          <div>
            <div class="widgetbar">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <div class="custom-file">
                        <input accept="image/*" type="file" name="user_img" class="custom-file-input" id="user_img"
