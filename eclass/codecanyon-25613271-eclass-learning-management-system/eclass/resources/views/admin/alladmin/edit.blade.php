    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        <div class="card-header">
          <h5 class="box-title">{{ __('Edit Admin') }}</h5>
          <div class="widgetbar">
            <a href="{{ url('user') }}" class="btn btn-primary-rgba mr-2" title="{{ __('Back') }}"><i
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="{{ __('Please Enter City') }}" onchange="get_state_country(this.value)" value="{{$cities?$cities->name:''}}">
