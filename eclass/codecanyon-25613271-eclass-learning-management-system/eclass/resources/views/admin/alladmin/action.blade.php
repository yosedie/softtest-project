<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
        <a class="dropdown-item" href="{{ route('alladmin.edit',$id) }}" title="{{ __('Edit') }}"><i
                class="feather icon-edit mr-2"></i>{{__('Edit')}}</a>
        <a class="dropdown-item btn btn-link" data-toggle="modal"
            data-target="#deleteadmin{{ $id }}" title="{{ __('Delete') }}">
...
<!-- delete Modal start -->
<div class="modal fade bd-example-modal-sm" id="deleteadmin{{$id}}"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="post"
                    action="{{ route('alladmin.delete',$id) }}"
                    class="pull-right">
                    {{csrf_field()}}
                    {{method_field("DELETE")}}
