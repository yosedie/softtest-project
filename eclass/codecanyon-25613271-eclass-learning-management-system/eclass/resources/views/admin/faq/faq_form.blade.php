...
@section('title', 'Add FAQs Students')
@section('maincontent')
<?php
$data['heading'] = 'Add FAQs Students';
$data['title'] = 'FAQs';
$data['title1'] = 'FAQs Students';
$data['title2'] = 'Add FAQs Students';
?>
    ...
    <div class="col-lg-12">
        <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"> {{ __('Add FAQs Students') }}</h5>
                    <div>
                        <div class="widgetbar">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="detail" name="details" class="@error('description') is-invalid @enderror" placeholder="Please Enter Answer" required="">{{ old('description') }}</textarea>
                                                            @error('description')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
