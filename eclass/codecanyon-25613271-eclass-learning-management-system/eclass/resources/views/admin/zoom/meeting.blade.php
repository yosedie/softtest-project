      ...
      <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('All Zoom Meetings')}}</h5>
                    <div>
                      <div class="widgetbar">
                    <a href="page-product-detail.html" class="btn btn-danger-rgba"  data-toggle="modal" data-target=".bd-example-modal-sm1" title="{{ __('Delete Selected') }}"><i class="feather icon-trash mr-2"></i>Delete Selected</a>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p><b>{{ __('Timing') }}:</b> {{ date('d-m-Y | h:i:s A',strtotime($meeting['start_time'])) }}</p>
                ...
                <td>
                  <a href="{{ $meeting->zoom_url }}" target="_blank" class="btn btn-primary-rgba" title="{{ __('Join Meeting') }}">{{ __('Join Meeting') }}</a>
                </td>
                    <td>
