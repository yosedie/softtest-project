...
@section('maincontent')
<?php
$data['heading'] = 'Create Feature';
$data['title'] = 'Front Settings';
$data['title1'] = 'Feature';
$data['title2'] = 'Create Feature';
?>
        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"> {{ __('Add Feature') }}</h5>
                    <div>
                        <div class="widgetbar">
                            <a href="{{url('feature')}}" class="btn btn-primary-rgba" title="{{ __('Back')}}"><i class="feather icon-arrow-left mr-2"></i>{{ __("Back")}}</a>
                        </div>
                    </div>
                </div>
                <!-- card body started -->
                <div class="card-body">
                    <!-- form start -->
                    <form action="{{action('FeaturesController@store')}}" class="form" method="POST" novalidate
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="text-dark">{{ __('Feature') }} : <span
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <button type="reset" class="btn btn-danger-rgba mr-1" title="{{ __('Reset')}}"><i
