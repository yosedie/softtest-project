...
@section('title', 'FAQs Instructors')
@section('maincontent')
<?php
    ...
    <div class="col-lg-12">
        <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box">{{ __('FAQ Instructors') }}</h5>
                    <div>
                        <div class="widgetbar">
                        ...
                        <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete" title="{{ __('Delete Selected') }}"><i
                          ...
                          <a href="{{url('faqinstructor/create')}}" class="float-right btn btn-primary-rgba mr-2" title="{{ __('Add FAQs') }}"><i class="feather icon-plus mr-2"></i>{{ __('Add FAQs') }}</a>
                                  @endcan
                        </div>
                      </div>
                </div> 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            ...
                                            <a class="dropdown-item" href="{{url('faqinstructor/'.$p->id.'/edit')}}" title="{{ __('Edit') }}"><i class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
                                            @endcan
                                            @can('faq.faq-instructor.delete')
