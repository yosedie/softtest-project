...
@section('title', 'Edit FAQs Instructors')
@section('maincontent')
<?php
$data['heading'] = 'Edit FAQs Instructors';
$data['title'] = 'FAQs';
$data['title1'] = 'FAQs Instructors';
$data['title2'] = 'Edit FAQs Instructors';
?>
    ...
    <div class="col-lg-12">
        ...
        <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"> {{ __('Edit FAQs Instructors') }}</h5>
                    <div>
                        <div class="widgetbar">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="detail" rows="3" name="details" class="@error('details') is-invalid @enderror" placeholder="{{ __('Please Enter Answer') }}" required="">{{$find->details}}</textarea>
                                                            @error('details')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
