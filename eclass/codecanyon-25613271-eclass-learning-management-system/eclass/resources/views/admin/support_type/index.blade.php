        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box">{{ __('Support Type') }}</h5>
                    <div>
                        <div class="widgetbar">
                            @can('blogs.delete')
                            ...
                            @endcan
                            @can('blogs.create')
                            <a href="{{route('supporttype.create')}}" class="float-right btn btn-primary-rgba mr-2"
                                title="{{ __('Support Type') }}"><i class="feather icon-plus mr-2"></i>{{ __('Support
                                Type')
                                }}</a>
                            @endcan
                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{url('/admin/support/type/'.$data->id.'/edit')}}"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="post"
                                                            action="{{url('/admin/support/type/'.$data->id . '/delete')}}"
                                                            class="pull-right">
                                                            {{csrf_field()}}
                                                            {{method_field("DELETE")}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="bulk_delete_form" method="post"
                        action="{{ route('supporttype.bulk_delete') }}">
                        @csrf
                        @method('POST')
