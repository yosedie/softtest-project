		...
		<script type="text/javascript">
			FWDUVPUtils.onReady(function(){
				...
				new FWDUVPlayer({		
					...
					showShareButton:"no",
					@endif
					@if(optional($psetting)->embedded_enable ==1)
					showEmbedButton:"yes",
					@else
					showEmbedButton:"no",
					@endif
					...
					enable360Vid:"yes",
					default360DegreeView:"360",
					video360DegreeStartAt:0.1,
        			totalSpherePixels: 3000000,
						...
						@endif
							...
							@endphp
							    ...
							    <div data-video-short-description="">
				        			 ...
				        			 <p class="fwduvp-categories-description"><span class="fwduvp-header">{{__('Descriptions:')}} </span>{{ $chapter->courses->short_detail }}</p>
							    </div>
