  ...
  <body>
    @include('admin.message')
      <div class="preL display-none">
                              ...
                              <td>
                               ...
                               @else
                                <i class="text-danger fa fa-times-circle"></i>
                                 <i class="text-success fa fa-times-circle"></i> {{ __('php version required greater than 8.1') }}
                                 @php
        ...
        <p class="text-center m-3 text-white">&copy;{{ date('Y') }} {{ __('| eClass - Learning Management System | Installer v1.1 |') }} <a class="text-white" href="http://mediacity.co.in">{{ __('Media City') }}</a></p>
   		</div>
