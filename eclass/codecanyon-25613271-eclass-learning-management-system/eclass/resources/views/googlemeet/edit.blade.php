					...
					<form autocomplete="off" action="{{ route('googlemeet.update',$googlemeetedit['meeting_id']) }}"
						...
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<div style="{{ isset($googlemeetedit['link_by']) == 'course' ? '' : 'display:none' }}" id="sec1_one">
							...
							<div class="form-group col-md-4">
								...
								{{ $googlemeetedit->paid_meeting_toggle ? 'checked' : '' }}>
								<div id="paidMeetingPrice" style="{{ $googlemeetedit->paid_meeting_toggle ? '' : 'display:none;' }}">
									...
									value="{{ $googlemeetedit->paid_meeting_price }}">
								</div>
							</div>
						</div>
