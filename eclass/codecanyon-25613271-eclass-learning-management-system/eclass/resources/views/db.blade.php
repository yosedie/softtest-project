      ...
      <div class="preL display-none">
        <div class="preloader3 display-none"></div>
          ...
          <div class="card-header">
            ...
            <form autocomplete="off" action="{{ route('db.next') }}" id="step2form" method="POST" class="database-validation" novalidate>
              @csrf
              ...
              <div class="row">
                ...
                <button class="float-right step1btn btn btn-primary" type="submit">{{__('Continue')}}</button>
              </div>
            </form>
